...
public class MainActivity extends AppCompatActivity {
    ...
    public void universalPrinter(){
        ...
        entries.add(new PosPrinter.PosPrinterEntry("From: Embu",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("Office No: 0703886940",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("To: NYERI LOWER",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("Office No: 0703886940",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("Sender: David",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("S. Phone: 0703886940",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("Receiver: David",false, "LEFT","STRING"));
        entries.add(new PosPrinter.PosPrinterEntry("R. Phone: 0703886940",false, "LEFT","STRING"));
